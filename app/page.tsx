...
import DropCap from "@/components/newspaper/DropCap";
import ArticleMeta from "@/components/newspaper/ArticleMeta";
...
export default function HomePage() {
  const { meta, article, profileImage, dossier, manifesto, refactoring, offDuty } =
    ABOUT_DATA;
